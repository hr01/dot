echo pacman-key initting (1/)
pacman-key --init;pacman-key --populate
echo pacman package updating... (2/)
pacman -Syyuu $INSTPACKAGE
echo yay installing... (3/)
...
wget "https://gist.github.com/koumaza/51452707aad4244e6d0ee951756bebab/raw/6b0a4f6fc96083d71f43a6a1a8c27b8ceaab7e38/useradd.sh";chmod a+x useradd.sh;bash useradd.sh